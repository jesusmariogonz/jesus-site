...
tesis: 'México puede sostener, al mismo tiempo, cifras récord de inversión extranjera directa y casi dos años y medio consecutivos de contracción manufacturera, porque son mediciones de fenómenos distintos: una mide el capital que decide quedarse o llegar, la otra mide si las fábricas que ya existen están produciendo más o menos que el mes anterior, y esa segunda pregunta lleva 29 meses respondiéndose que no.'
datosClave:
  - valor: '49.7 puntos'
    etiqueta: 'Indicador IMEF Manufacturero de agosto 2026, sin cambio frente a julio'
  - valor: '29 meses'
    etiqueta: 'Meses consecutivos que el sector manufacturero mexicano acumula en zona de contracción (por debajo de 50 puntos)'
  - valor: '48.7 puntos'
