...
tags:
  ...
  - Sesgos Cognitivos
  - Gestión de Equipos
resumen: 'En 1971, dos psicólogos documentaron por qué ganar la lotería o quedar parapléjico terminan, año y medio después, produciendo niveles de felicidad sorprendentemente parecidos. Ese mismo mecanismo explica por qué un ascenso, una meta de ventas cumplida o un proyecto exitoso dejan de sentirse como un logro casi tan pronto como se alcanzan —y se convierten, en cambio, en el nuevo mínimo aceptable.'
tesis: 'La "trampa de la línea base" no es simple ingratitud ni un problema de actitud que se resuelva con gratitud forzada: es la consecuencia predecible de un mecanismo psicológico documentado desde los años setenta —la relatividad hedónica—, y las organizaciones que promueven una cultura de "superar la meta anterior" sin ningún mecanismo de recalibración están, sin saberlo, diseñando el agotamiento crónico de su gente de más alto desempeño como una característica estructural, no como un accidente.'
datosClave:
  - valor: "1971"
    etiqueta: "Año en que Philip Brickman y Donald Campbell formalizaron la teoría de la relatividad hedónica, base científica de lo que hoy se llama 'trampa de la línea base'"
  - valor: "~1-2 años"
    etiqueta: "Tiempo que, según el estudio seminal de Brickman, toma que la mayoría de las personas regrese a su nivel de bienestar subjetivo previo tras un evento vital importante, positivo o negativo"
  - valor: "90%"
    etiqueta: "Proporción de los casos en que, según la teoría de fijación de metas de Locke y Latham, las metas específicas y desafiantes (pero no imposibles) producen mejor desempeño que las metas fáciles"
imagen: /blog/portadas/la-trampa-de-la-linea-base.jpg
---
...
- [Hedonic Adaptation: The Treadmill That Resets Happiness](https://yukaichou.com/behavioral-analysis/hedonic-adaptation-brickman-campbell-hedonic-treadmill/) — Yu-kai Chou
- [HEDONIC TREADMILL](https://cdn2.psychologytoday.com/assets/hedonictreadmill.pdf) — Psychology Today
- [Hedonic relativism and planning the good society](https://www.semanticscholar.org/paper/Hedonic-relativism-and-planning-the-good-society-Brickman-Campbell/705b7748c08bfdd1808d76a6b10a37842a2482ef) — Semantic Scholar (referencia del artículo original de Brickman & Campbell, 1971)
- [Why Success Stops Feeling Good: The Psychology of the Hedonic Treadmill](https://medium.com/@haileymagee/why-success-stops-feeling-good-the-psychology-of-the-hedonic-treadmill-ae71ff0d76b8) — Hailey Magee
- [New Directions in Goal-Setting Theory](https://home.ubalt.edu/tmitch/642/articles%20syllabus/locke%20latham%20new%20dir%20gs%20curr%20dir%20psy%20sci%202006.pdf) — Edwin A. Locke y Gary P. Latham
- [Arrival Fallacy and the Pursuit of Happiness](https://psychologyfanatic.com/arrival-fallacy/) — Psychology Fanatic
