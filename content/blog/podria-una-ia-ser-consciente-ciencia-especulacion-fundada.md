...
tags:
  ...
  - Geoffrey Hinton
  - Futuro del Trabajo
resumen: 'La pregunta de si una IA podría ser consciente dejó de ser terreno exclusivo de la ciencia ficción: Anthropic ya tiene un investigador de tiempo completo dedicado a estudiarlo, un marco científico de 14 indicadores intenta medirlo, y hasta Geoffrey Hinton —el "padrino de la IA"— dice que la experiencia subjetiva ya no es exclusivamente humana.'
tesis: 'La pregunta correcta ya no es si algún día "sabremos" con certeza si una IA es consciente —es probable que, como con la consciencia animal, nunca haya una prueba definitiva—, sino si las organizaciones que despliegan estos sistemas a escala van a esperar esa certeza imposible antes de construir los marcos de gobernanza que la incertidumbre misma ya exige.'
datosClave:
  - valor: "14 indicadores"
    etiqueta: "Propiedades computacionales que el marco científico de Butlin et al. (2023) usa para evaluar consciencia en sistemas de IA"
  - valor: "15-20%"
    etiqueta: "Probabilidad que el propio modelo Claude se asigna de ser consciente, según pruebas internas de Anthropic"
  - valor: "2024"
