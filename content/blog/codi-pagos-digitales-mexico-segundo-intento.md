...
tags:
  ...
  - fintech
  - México
resumen: 'El gobierno mexicano prepara para septiembre un ecosistema unificado de pagos digitales con QR, inspirado en el Pix brasileño y el UPI indio, apenas semanas después de que Banxico reconociera que CoDi —su intento anterior con la misma tecnología— fue usado alguna vez por apenas 1% de la población mexicana, frente a 82% en Brasil.'
tesis: 'La diferencia entre el fracaso de CoDi y el éxito de Pix no fue la tecnología —ambos usan el mismo mecanismo de código QR y transferencia instantánea—, fue el diseño de incentivos alrededor de esa tecnología, y hasta que el segundo intento mexicano resuelva exactamente los mismos problemas de incentivos bancarios, desconocimiento del producto y desconfianza fiscal que hundieron al primero, ningún relanzamiento con mejor diseño de interfaz va a mover la aguja del uso de efectivo en México.'
datosClave:
  - valor: '1% vs. 82%'
    etiqueta: 'Proporción de la población que ha usado CoDi en México frente a Pix en Brasil'
  - valor: '21.8 millones'
    etiqueta: 'Cuentas validadas en CoDi, de las cuales menos de 2.5 millones han hecho al menos un pago'
  - valor: '174 millones'
...
- [México prepara ecosistema de pagos digitales para reducir el uso cotidiano del efectivo](https://www.excelsior.com.mx/finanzas/pagos-digitales-mexico) — Excélsior
- [Por estas razones el CoDi ha fracasado como medio de pago, según estudio de Banxico](https://forbes.com.mx/el-codi-ha-fracasado-como-medio-de-pago-por-la-informalidad-el-miedo-al-sat-y-la-pandemia/) — Forbes México
- [CoDi en coma: Sheinbaum culpa a los bancos por su fracaso y mira hacia Brasil](https://880noticias.info/economia/codi-en-coma-sheinbaum-culpa-a-los-bancos-por-su-fracaso-y-mira-hacia-brasil/) — Ocho Ochenta Noticias
- [Codi, app de Banxico que fortalecerá el cobro digital llegará en septiembre](https://marketing4ecommerce.mx/codi-banxico-fortalecer-cobro-digital/) — Marketing4Ecommerce
- [Cambios en las transferencias bancarias en México en 2026](https://tribunademexico.com/cambios-transferencias-bancarias-mexico-banxico/) — Tribuna de México
- [Pix continua dominando e evoluindo, e 2026 marca um novo patamar para os pagamentos no Brasil](https://tiinside.com.br/es/06/02/2026/pix-continua-dominando-e-evoluindo-e-2026-marca-um-novo-patamar-para-os-pagamentos-no-brasil/) — TI Inside
- [UPI, da Índia, faz dez anos e deixa lições para o Pix](https://finsidersbrasil.com.br/pagamentos/upi-dez-anos-pix-india-um-trilhao-transacoes/) — Finsiders Brasil
