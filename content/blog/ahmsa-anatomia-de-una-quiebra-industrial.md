...
tags:
  ...
  - Sheinbaum
  - Agro Nitrogenados
resumen: 'Seis años después de que Altos Hornos de México dejara de pagar su deuda, la siderúrgica que alguna vez sostuvo el 8% del PIB de Coahuila llega a una subasta el 25 de septiembre con más de 61,000 millones de pesos en pasivos, un expresidente con un acuerdo de reparación incumplido ante Pemex y 17,000 empleos que nadie ha logrado proteger del todo.'
tesis: 'AHMSA no colapsó por las condiciones del mercado siderúrgico global: colapsó por una secuencia identificable de captura corporativa del aparato del Estado, una decisión regulatoria ejecutada sin mecanismo de transición y seis años de indefinición judicial — y es esa secuencia específica, no la etiqueta genérica de "crisis del acero", la que una solución seria tendría que desmontar para no repetirse en la siguiente industria estratégica que atraviese dificultades.'
datosClave:
  - valor: "61,000 mdp"
    etiqueta: "Deuda total reconocida de AHMSA y Minosa"
  - valor: "17,000"
    etiqueta: "Empleos directos en el pico de operación"
  - valor: "$1,326 mdd"
