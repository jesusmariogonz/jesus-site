...
export async function GET(request) {
  ...
  const session = await stripe().checkout.sessions.create({
    ...
    success_url: `${base}/the-toolkit/gracias?session_id={CHECKOUT_SESSION_ID}`,
    cancel_url: `${base}/the-toolkit`,
